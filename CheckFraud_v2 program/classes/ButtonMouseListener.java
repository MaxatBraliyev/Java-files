...
class ButtonMouseListener implements MouseListener {
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        try {
            ...
            test1.SetNumber(s1);test1.Charges();test1.Payment();test1.Detail();test1.Detail_Lac_Cell();test1.Aggr();test1.Block();

        } catch (SQLException ex) {
            ex.printStackTrace();
        }
        CheckFraudGui.Label17.setText(test1.getName()); CheckFraudGui.Label2.setText(test1.GetSubs()); CheckFraudGui.Label4.setText(test1.getAccount());
        CheckFraudGui.Label6.setText(test1.getClnt_id()); CheckFraudGui.Label8.setText(test1.getCt_name()); CheckFraudGui.Label10.setText(test1.getStatus());
        CheckFraudGui.Label12.setText(test1.getTrpl_name()); CheckFraudGui.Label14.setText(test1.getBalance_$().toString()); CheckFraudGui.Label24.setText(test1.getActivation_date());
        CheckFraudGui.Label26.setText(test1.getFirst_call());
